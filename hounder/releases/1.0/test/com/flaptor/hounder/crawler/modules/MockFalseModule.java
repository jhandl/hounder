 ...
 */
public class MockFalseModule extends ATrueFalseModule {
    private static final Logger logger = Logger.getLogger(Execute.whoAmI());
    /**
     * This tag will be set iff internalProcess was called
     */ 
    public static final String TAG_MOCKFALSE_INTERNAL_PROCESS_WAS_CALLED= 
        "tag_mocktrue_internal_process_was_called";

    private String echoMessage;
        
    public MockFalseModule (String name) throws Exception {
        super(name, TestUtils.getConfig());
    }
    
    public Set<String> getSetTag(){
        return onFalseSetTags;        
    }

    public Set<String> getUnsetTag(){
        return onFalseUnSetTags;        
    }
    ...
    protected Boolean tfInternalProcess(FetchDocument doc) {
        ...
        try {
            doc.addTag(TAG_MOCKFALSE_INTERNAL_PROCESS_WAS_CALLED);
        } catch (Exception e) {            
            e.printStackTrace();
